...
CREATE TABLE IF NOT EXISTS "census_education" (
    ...
    "county_id" char(3)   NOT NULL,
    "county_name" varchar(50)   NOT NULL,
    "%_eduction_pop_25_and_over_less_than_9th_grade" decimal(3)   NOT NULL,
    "%_eduction_pop_25_and_over_9th-12th_no_diploma" decimal(3)   NOT NULL,
    "%_eduction_pop_25_and_over_high_school_graduate" decimal(3)   NOT NULL,
    "%_eduction_pop_25_and_over_some_college_no_degree" decimal(3)   NOT NULL,
    "%_eduction_pop_25_and_over_associates_degree" decimal(3)   NOT NULL,
    "%_eduction_pop_25_and_over_bachelors_degree" decimal(3)   NOT NULL,
    "%_eduction_pop_25_and_over_graduate_or_professional_degree" decimal(3)   NOT NULL,
...
CREATE TABLE IF NOT EXISTS "census_industry" (
    ...
    "county_id" char(3)   NOT NULL,
    "county_name" varchar(50)   NOT NULL,
    "ind_agriculture_forestry_fishing_and_hunting_and_mining" int   NOT NULL,
    "ind_construction" int   NOT NULL,
    "ind_manufacturing" int   NOT NULL,
    "ind_wholesale_trade" int   NOT NULL,
    "ind_retail_trade" int   NOT NULL,
    "ind_transportation_and_warehousing_and_utilities" int   NOT NULL,
    "ind_information" int   NOT NULL,
    "ind_finance_and_insurance_real_estate_and_rental_and_leasing" int   NOT NULL,
    "ind_professional_scientific_mgt_admini_and_waste_mgt_services" int   NOT NULL,
    "ind_educational_services_health_care_and_social_assistance" int   NOT NULL,
    "ind_arts_entertainment_recreation_accommodation_and_food_servic" int   NOT NULL,
    "ind_other_services_except_public_administration" int   NOT NULL,
    "ind_public_administration" int   NOT NULL,
